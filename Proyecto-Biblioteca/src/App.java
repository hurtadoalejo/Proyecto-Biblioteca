public class App {
    public static void main(String[] args){
        ...
        Libro libro = new Libro("1", "1540", "Hugo", "Magia", "Planeta", 1980, 11,24, 5, EstadoLibro.DISPONIBLE);
        Libro libro2 = new Libro("2", "1023", "Gabo", "Flores", "Planeta", 2020, 11, 24, 7, EstadoLibro.DISPONIBLE);
        ...
        Prestamo prestamo = new Prestamo("1", bibliotecario, estudiante, 2024, 10, 4, 2000, EstadoPrestamo.PENDIENTE);
        Prestamo prestamo2 = new Prestamo("2", bibliotecario2, estudiante2, 2024, 10, 4, 3000, EstadoPrestamo.PENDIENTE);
